...
<head>
    ...
    <title>MaterialChat - Login ;)</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="login-box">
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" method="post" action="#">
                <h3 class="box-title-log m-b-20"><b><?php echo $lang['SIGNIN']; ?></b></h3>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="form-checkbox pull-left p-t-0">
                            <input class="form-check-input" id="checkbox-signup" type="checkbox">
                            <label class="form-check-label" for="checkbox-signup"> <?php echo $lang['REMEMBERME']; ?></label>
                          </div>
                            <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> <?php echo $lang['FORGOTPASS']; ?></a> </div>
                        </div>
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p><b><?php echo $lang['DONTHAVACCOUNT']; ?>?</b> <a href="register.php" class="text-primary m-l-5"><b><?php echo $lang['SIGNUP']; ?></b></a></p>
                    </div>
                </div>
            </form>
            <form class="form-horizontal" id="recoverform" action="login_user.php">
        <div class="form-group ">
          <div class="text-center col-xs-12">
            <h3><?php echo $lang['FORGOTPASS']; ?></h3>
              <p class="text-muted"><?php echo $lang['ENTERYOUEMAILDESC']; ?> </p>
        </div>
      </div>
      <div class="form-group ">
        <div class="col-xs-12">
     ...
     <div class="form-group text-center m-t-20">
    <div class="col-xs-12">
        <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo $lang['RESET']; ?></button>
    </div>
    </div>
    </form>
