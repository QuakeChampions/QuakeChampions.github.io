...
if(isset($_POST['signup']))
{
    ...
    if($errors['username'] == 1)
    {
            ...
            $from = $_POST['site_title'];
            $to = $_POST['username'];
            $to_id = $user_id;
            $from_id = 1;
            $message = "Weclome you can test better if you login with 2 diffrent browser and with other userid. Also Seacrh user and start chat with people.";
...
<head>
    ...
    <title>MaterialChat - Create Account ;)</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="login-box">
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" action="#" method="post" enctype="multipart/form-data">
                <h3 class="box-title text-center m-b-20"><b><?php echo $lang['SIGNUP']; ?></b></h3>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="checkbox checkbox-primary p-t-0">
                            ...
                            <label for="checkbox-signup"data-toggle="modal" data-target="#Terms"> <?php echo $lang['IAGREETOTERM']; ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p><b><?php echo $lang['ALREDYHAVACCOUNT']; ?>?</b> <a href="login_user.php" class="text-primary m-l-5"><b><?php echo $lang['SIGNIN']; ?></b></a></p>
                    </div>
                </div>
            </form>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="Terms"><b><?php echo $lang['TITLETERM']; ?></b></h5>
      </div>
      <div class="modal-body">
        <?php echo $lang['TEXTTERM']; ?>
      </div>
