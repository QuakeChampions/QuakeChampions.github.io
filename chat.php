        ...
        while($row=mysqli_fetch_array($sql_res))
        {
            ...
            <li class="person chatboxhead" id="chatbox1_<?php echo $username ?>" data-chat="person_<?php echo $id ?>" href="javascript:void(0);" onclick="javascript:chatWith('<?php echo $username ?>','<?php echo $id ?>','<?php echo $sesuserpic; ?>','<?php echo $onofst ?>')">
                <a href="javascript:void(0)">
                    <span class="userimage profile-picture min-profile-picture"><img src="storage/user_image/<?php echo $picname; ?>" alt="<?php echo $username ?>" class="bg-images-users"></span>
            <span>
    ...
    <div class="">
        ...
        <div class="user-btm-box">
            ...
            <div class="row text-center m-t-10">
                <div class="col-md-6 b-r"><p><?php echo $name ?></p></div>
                <div class="col-md-6"><p><?php echo $sex ?></p></div>
            </div>
            <!-- /.row -->
            <hr>
            <!-- .row -->
            <div class="row text-center m-t-10">
                <div class="col-md-12"><p><?php echo $status ?> </p></div>
...
function chatfrindList($con,$config) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <li class="person chatboxhead" id="chatbox1_<?php echo $username ?>" data-chat="person_<?php echo $id ?>" href="javascript:void(0)" onclick="javascript:chatWith('<?php echo $username ?>','<?php echo $id ?>','<?php echo $sesuserpic; ?>','<?php echo $onofst ?>')">
            <a href="javascript:void(0)">
                <span class="userimage profile-picture min-profile-picture"><img src="<?php echo $config['site_url']; ?>storage/user_image/<?php echo $picname; ?>" alt="<?php echo $username ?>" class="avatar-image is-loaded bg-images-users" width="100%"></span>
                <span>
