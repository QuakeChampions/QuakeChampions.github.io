...
if ($extension=="jpg" || $extension=="jpeg" || $extension=="gif" || $extension == "png" || $extension == "JPG") {
    $file_type = "image";
    ...
    if ($image)
    {
        ...
        imagejpeg($tmp,$filename,225);

        imagedestroy($src);
        imagedestroy($tmp);
    }
}
elseif ($extension=="mp4" || $extension=="MP4" || $extension=="flv" || $extension=="avi" || $extension=="WebM" || $extension=="mkv") {
    $file_type = "video";
}
elseif($extension=="doc" || $extension=="pdf" || $extension=="text") {
    $file_type = "document";
}
